...
public class CargarLicencia extends javax.swing.JFrame {
    ...
    //MÃ©todo privado para Limpiar los campos de Licencia
    	private void Limpiar_Campos(){
         ...
         //MÃ¨todo para validar que los campos tengan informaciÃ³n
    	private boolean ValidarCampos(){
    		...
    		if (diasValue.getText().length() == 0){
    			JOptionPane.showMessageDialog(null,"Ingrese la Cantidad de DÃ­as",
    			"ArrayList",JOptionPane.ERROR_MESSAGE);
    ...
    private void initComponents() {
        ...
        motivoLicenciaValue.addItem("Día de Exámen");
